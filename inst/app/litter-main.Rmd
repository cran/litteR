...
all(available_codes_data_file %in% available_codes_group_file) || stop(sprintf(str_c(
    "The following types in data file %s are missing or\n",
    "not assigned to groups in group file %s:\n%s\n",
    "Please add these types to the group file and ",
    "mark the groups they belong to with an 'x'."),
    INPUT_FILE_NAME %>%
      path_file %>%
      sQuote,
    GROUPS_FILE_NAME %>%
